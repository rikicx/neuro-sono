...
const TAG_RULES = [
  ...
  { id: "exames", label: "Exames do Sono", kws: ["polissonografia", "eletroencefalo", " eeg", "eeg ", "eeg)", "mapeamento eletrico", "eletroneuromiografia", "titulacao"] },
  { id: "parassonias", label: "Parassonias", kws: ["sonambulismo", "terror noturno", "pesadelo", "sono rem", "pernas inquietas", "willis-ekbom", "willis ekbom", "movimento sono", "epilepsia"] },
  ...
  { id: "sonolencia", label: "Sonolência", kws: ["sonolencia", "latencia do sono", "manutencao da vigilia", "narcolepsia"] },
